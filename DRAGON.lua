...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/So_Offline"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0," 🔺︙ العضو : {["..data.first_name_.."](t.me/So_Offline)}\n 🔺︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🔺︙ عذرا ↫ {["..data.first_name_.."](t.me/So_Offline)}\n 🔺︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━━━━━❲☆[ᴏғғʟɪɴᴇ](t.me/So_Offline)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ](t.me/So_Offline)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/So_Offline)
╰━━━━━❲☆[ᴏғғʟɪɴᴇ](t.me/So_Offline)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
...
{{text = '𝐢𝐬??𝐚𝐦 𝐝𝐚𝐡𝐚𝐛',url="t.me/Amvggddghhgddsfhhfddhh"}},
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐟𝐟𝐥𝐢𝐧', url="t.me/So_Offline"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/So_Offline/388&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '⁽♔₎ ᴏғғʟɪɴᴇ|:☁ ', url="t.me/So_Offline"}},
{{text = 'تواصل السورس ',url="t.me/Hdudbdbot"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{{text = '𝐢𝐬𝐥𝐚𝐦 𝐝𝐚𝐡𝐚𝐛',url="t.me/Amvggddghhgddsfhhfddhh"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/So_Offline"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
مالك سورس افلاين لو حباب تتواصل معها اتبع الزر الي تحت👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙄𝙂𝙀𝙍',url="t.me/Dev_RE9"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ✅', url="t.me/So_Offline"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=http://t.me/So_Offline/4/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
function(arg,data) 
usertext = '\n 🔺︙ العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or '@So_Offline')..')'
...
usertext = '\n 🔺︙ العضو ↫ ['..result.title_..'](t.me/'..(username or '@So_Offline')..')'
...
local TextE = "\n•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n 🔺︙ علامة تعني { ✔️ } ملف مفعل\n 🔺︙ علامة تعني { ✖ } ملف معطل\n 🔺︙ قناة سورس افلاين ↓\n".." 🔺︙ [اضغط هنا لدخول](t.me/So_Offline) \n"
local NumFile = 0
...
if Mod(msg) then     
if AddChannel(msg.sender_user_id_) == false then
local So_Offline = database:get(bot_id..'text:ch:user')
if So_Offline then
send(msg.chat_id_, msg.id_,'['..So_Offline..']')
else
send(msg.chat_id_, msg.id_,' 🕊 لا تستطيع استخدام البوت \n  🕊 يرجى الاشتراك بالقناه اولا \n  🕊 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/So_Offline)') 
return false
end
...
[𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ](t.me/So_Offline)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ', url="t.me/So_Offline"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
